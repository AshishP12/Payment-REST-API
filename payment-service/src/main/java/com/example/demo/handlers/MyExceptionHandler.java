...
public class MyExceptionHandler {
    ...
    public MyErrorHandler globslHandleElementNotFound(Exception ex,WebRequest req) {
        return new MyErrorHandler(LocalDateTime.now(),ex.getMessage()+"FROM GLOBAA HANDLER",req.getDescription(false));
    }
